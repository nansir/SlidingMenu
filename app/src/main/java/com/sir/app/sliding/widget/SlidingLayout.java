package com.sir.app.sliding.widget;
...
import com.sir.app.sliding.R;
import com.sir.app.sliding.utils.ScreenUtils;
...
public class SlidingLayout extends HorizontalScrollView {
    ...
    public SlidingLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (attr == R.styleable.SlidingLayout_rightPadding) {// 默认50
